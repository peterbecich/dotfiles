...
myKeys = [
  ...
  -- ,
  ((mod4Mask, xK_s), spawn "xscreensaver-command; sleep 2; systemctl suspend; sleep 2; xrandr --output DP-2 --auto --panning 3840x2160+3840+0 --output DP-2 --panning 3840x2160+0+0 --right-of DP-4")
