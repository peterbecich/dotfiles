...
(custom-set-variables
 ...
 '(intero-extra-ghc-options (quote ("-j4 -threaded -rtsopts -with-rtsopts=-N")))
 '(intero-extra-ghci-options (quote ("-j4 -threaded -rtsopts -with-rtsopts=-N")))
