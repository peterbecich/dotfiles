...
(custom-set-variables
 ...
 '(erc-autojoin-channels-alist
   (quote
    (("verne.freenode.net" "#apache-spark" "#hackerrank" "#purescript" "#yesod" "#nicta-course" "#erlang" "#clojure" "#postgresql" "#web" "#hackernews" "##math" "#git" "#debian" "#wikipedia-en" "#lesswrong" "#scalaz" "#scala" "#haskell-lens" "#xmonad" "#haskell-beginners" "#haskell" "#emacs"))))
